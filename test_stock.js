...
async function test() {
  ...
  const fields = gqlData.data.__type.fields;
  
  const saveProductStockLocations = fields.find(f => f.name === 'saveProductStockLocations');
  console.log('Stock Mutation Args:', JSON.stringify(saveProductStockLocations, null, 2));
